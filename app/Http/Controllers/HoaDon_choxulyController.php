...
<body>
<p>Ngày in: '.$date.'</p>
<h2>BIÊN NHẬN BÁN HÀNG (COD)</h2>
<h4> Thông tin khách hàng </h4>
<ul id="border">
  <li>Họ và tên khách hàng: '.$khachhang[0]->ho_ten.'</li>
  <li>Điện thoại: '.$khachhang[0]->dien_thoai.'</li>
  <li>Ngày đặt hàng: '.$hoadon[0]->thoigian.'</li>
  <li>Địa chỉ giao hàng: '.$khachhang[0]->dia_chi.'</li>
</ul>
<br>
...
<ul id="tongtien">
  ...
  <li>Tổng cộng: '.$hoadon[0]->khach_can_tra.'</li>
</ul>
<br>
<br>
<br>
...
<br>
<br>
<i>Lưu ý: Sản phẩm đổi được đổi trả trong vòng 6h đối với các sản phẩm khô. Không áp dụng đối với các sản
phẩm tươi sống </i><br>
<i> Sản phẩm đổi phải còn nguyên tình trạng ban đầu </i>

<b><i> Cảm ơn quý khách đã tin dùng sản phẩm của TheCosmo</i></b>
